...
if [ -d $COM_POWAZORD_CHEF_UBUNTU_HOTH_CLONE_DIR ]
then
    rm -rf $COM_POWAZORD_CHEF_UBUNTU_HOTH_CLONE_DIR
fi
...
sudo chef-solo -c $COM_POWAZORD_CHEF_UBUNTU_HOTH_CLONE_DIR/solo.rb && rm -rf $COM_POWAZORD_CHEF_UBUNTU_HOTH_CLONE_DIR
